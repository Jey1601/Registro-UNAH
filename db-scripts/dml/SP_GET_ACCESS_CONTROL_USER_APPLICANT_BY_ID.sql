--DROP PROCEDURE SP_GET_ACCESS_CONTROL_USER_APPLICANT_BY_ID;
DELIMITER $$
CREATE PROCEDURE SP_GET_ACCESS_CONTROL_USER_APPLICANT_BY_ID(IN idUser INT)
BEGIN
    SELECT  
...
CALL SP_GET_ACCESS_CONTROL_USER_APPLICANT_BY_ID(2);