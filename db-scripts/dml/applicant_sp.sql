...
BEGIN
    ...
    SELECT 
        ...
        first.name_undergraduate,
        second.name_undergraduate,
    ...
    INNER JOIN Undergraduates AS first ON Applications.intendedprimary_undergraduate_applicant = first.id_undergraduate
    INNER JOIN Undergraduates AS second ON Applications.intendedsecondary_undergraduate_applicant = second.id_undergraduate
